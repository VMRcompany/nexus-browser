    ...
    <div className={`flex h-screen w-full font-sans transition-colors duration-300 overflow-hidden bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100`}>
      ...
      <aside className={`hidden lg:flex flex-col w-64 border-r p-4 gap-2 border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950`}>
        ...
        <nav className="flex flex-col gap-1 flex-1 overflow-y-auto">
          ...
          {activeProfile.bookmarks.slice(0, 5).map(b => (
            <button key={b.id} onClick={() => navigateTo(b.url)} className="text-xs text-left px-3 py-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg truncate text-zinc-600 dark:text-zinc-400">
              {b.title}
            </button>
          ))}
        </nav>
        ...
        <div className="border-t border-zinc-200 dark:border-zinc-800 pt-4 flex flex-col gap-1">
          <button 
            ...
            className="flex items-center gap-3 w-full p-3 rounded-xl text-zinc-600 dark:text-zinc-400 hover:bg-gray-100 dark:hover:bg-gray-800 transition-all"
          >
            <Shield size={20} />
      ...
      <main className="flex-1 flex flex-col min-w-0 relative">
        ...
        <header className={`h-16 border-b flex items-center px-4 gap-4 backdrop-blur-md z-10 bg-white/80 dark:bg-zinc-950/80 border-zinc-200 dark:border-zinc-800`}>
          <button className="lg:hidden p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg" onClick={() => setIsSidebarOpen(true)}>
            <Menu size={20} />
          </button>

          <div className="flex items-center gap-1">
            <button 
              className={`p-2 rounded-lg transition-colors ${historyIndex > 0 ? 'text-zinc-600 dark:text-zinc-300 hover:bg-gray-100 dark:hover:bg-gray-800' : 'text-zinc-300 dark:text-zinc-700 cursor-not-allowed'}`}
              onClick={goBack}
            ...
            <button 
              className={`p-2 rounded-lg transition-colors ${historyIndex < historyStack.length - 1 ? 'text-zinc-600 dark:text-zinc-300 hover:bg-gray-100 dark:hover:bg-gray-800' : 'text-zinc-300 dark:text-zinc-700 cursor-not-allowed'}`}
              onClick={goForward}
            ...
            <button 
              className="p-2 text-zinc-600 dark:text-zinc-300 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors" 
              onClick={reload}
            >
              <RotateCw size={18} />
            </button>
          ...
          <div className="flex items-center gap-2">
            <button 
              onClick={addBookmark}
              className={`p-2 rounded-lg transition-colors ${isIncognito ? 'hidden' : 'text-zinc-600 dark:text-zinc-400 hover:bg-gray-100 dark:hover:bg-gray-800'}`}
              title={t.bookmarks}
            >
              <Bookmark size={20} />
            </button>
            <button 
              ...
              className={`p-2 rounded-lg transition-colors ${isIncognito ? 'text-zinc-100 bg-zinc-800' : 'text-zinc-600 dark:text-zinc-400 hover:bg-gray-100 dark:hover:bg-gray-800'}`}
              title={t.incognito}
            >
              <Monitor size={20} />
            </button>
            <button 
              ...
              className={`p-2 rounded-lg transition-colors ${activeProfile.settings.adBlockEnabled ? 'text-green-500 bg-green-500/10' : 'text-zinc-600 dark:text-zinc-400 hover:bg-gray-100 dark:hover:bg-gray-800'}`}
              title={t.adBlock}
            >
            ...
            <div className="relative flex items-center gap-1">
              <button 
                ...
                className="p-2 text-zinc-600 dark:text-zinc-400 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors relative"
                title={t.tabs}
              >
                <Layers size={20} />
              ...
              <button 
                ...
                className="p-2 text-zinc-600 dark:text-zinc-400 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors"
              >
                  ...
                  <>
                    ...
                    >
                      ...
                      <button 
                        ...
                        className={`w-full flex items-center gap-3 px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors ${isStandardMode ? 'text-blue-500' : ''}`}
                      >
            ...
            <button 
              ...
              className="flex items-center gap-2 p-1 pr-3 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full transition-all"
            >
              ...
              >
                ...
                <div className="flex gap-2">
                  ...
                  <button 
                    ...
                    className="flex-1 bg-gray-100 dark:bg-zinc-800 text-xs font-bold py-2 rounded-xl hover:bg-gray-200 dark:hover:bg-zinc-700 transition-colors"
                  >
                    {t.delete}
                  </button>
                </div>
                ...
                <div className="flex flex-col gap-2">
                  {availablePasswords.map(p => (
                    <button 
                      ...
                      className="w-full text-left p-3 rounded-xl hover:bg-gray-100 dark:hover:bg-zinc-800 transition-all flex items-center justify-between group"
                    >
            ...
            <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.95, opacity: 0 }} className="relative w-full max-w-2xl bg-white dark:bg-zinc-900 rounded-3xl shadow-2xl overflow-hidden p-6 max-h-[80vh] flex flex-col">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex gap-2">
                  ...
                  <button onClick={() => setIsTabsOpen(false)} className="p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full"><X size={20} /></button>
                </div>
              </div>
            ...
            >
              ...
              <div className="p-6 flex flex-col gap-8">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button 
                    onClick={toggleAdBlock}
                    className={`w-12 h-6 rounded-full transition-colors relative ${activeProfile.settings.adBlockEnabled ? 'bg-blue-600' : 'bg-gray-300 dark:bg-zinc-700'}`}
                  >
                    <motion.div 
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <button 
                      ...
                      className="w-full py-3 border-2 border-dashed border-gray-200 dark:border-zinc-800 rounded-2xl text-zinc-500 dark:text-zinc-400 hover:text-blue-500 hover:border-blue-500 transition-all text-sm font-medium flex items-center justify-center gap-2"
                    >
              ...
              <form onSubmit={handleAddSearchEngine} className="flex flex-col gap-4">
                <div>
                  ...
                  <input 
                    ...
                    className="w-full p-3 bg-gray-50 dark:bg-zinc-800 rounded-xl outline-none focus:ring-2 focus:ring-blue-500"
                    required
                  />
                </div>
                <div>
                ...
                <div className="flex gap-2 mt-4">
                  <button type="button" onClick={() => setIsAddSearchOpen(false)} className="flex-1 py-3 bg-gray-100 dark:bg-zinc-800 rounded-xl font-bold">{t.delete}</button>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.95, opacity: 0 }} className="relative w-full max-w-md bg-white dark:bg-zinc-900 rounded-3xl shadow-2xl overflow-hidden p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <button onClick={() => setIsProfilesOpen(false)} className="p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full"><X size={20} /></button>
              </div>
              <div className="flex flex-col gap-3 mb-6">
                {profiles.map(p => (
                  <button 
                    ...
                    className={`flex items-center justify-between p-4 rounded-2xl border-2 transition-all ${
                      activeProfileId === p.id ? 'border-blue-600 bg-blue-600/5' : 'border-transparent bg-gray-50 dark:bg-zinc-800/50'
                    }`}
                  >
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.95, opacity: 0 }} className="relative w-full max-w-md bg-white dark:bg-zinc-900 rounded-3xl shadow-2xl overflow-hidden p-6 max-h-[80vh] flex flex-col">
              <div className="flex items-center justify-between mb-6">
                ...
                <button onClick={() => setIsPasswordsOpen(false)} className="p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full"><X size={20} /></button>
              </div>
              <div className="flex-1 overflow-y-auto flex flex-col gap-3">
                {activeProfile.passwords.length === 0 ? (
                  ...
                  activeProfile.passwords.map(p => (
                    <div key={p.id} className="p-4 bg-gray-50 dark:bg-zinc-800/50 rounded-2xl flex items-center justify-between">
                      <div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.95, opacity: 0 }} className="relative w-full max-w-md bg-white dark:bg-zinc-900 rounded-3xl shadow-2xl overflow-hidden p-6 max-h-[80vh] flex flex-col">
              <div className="flex items-center justify-between mb-6">
                ...
                <button onClick={() => setIsBookmarksOpen(false)} className="p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full"><X size={20} /></button>
              </div>
              <div className="flex-1 overflow-y-auto flex flex-col gap-3">
                {activeProfile.bookmarks.length === 0 ? (
                  ...
                  activeProfile.bookmarks.map(b => (
                    <div key={b.id} className="p-4 bg-gray-50 dark:bg-zinc-800/50 rounded-2xl flex items-center justify-between">
                      <button 
            ...
            <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.95, opacity: 0 }} className="relative w-full max-w-md bg-white dark:bg-zinc-900 rounded-3xl shadow-2xl overflow-hidden p-6 max-h-[80vh] flex flex-col">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex gap-2">
                  ...
                  <button onClick={() => setIsHistoryOpen(false)} className="p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full"><X size={20} /></button>
                </div>
              </div>
              <div className="flex-1 overflow-y-auto flex flex-col gap-3">
                {activeProfile.history.length === 0 ? (
                  ...
                  activeProfile.history.map(h => (
                    <div key={h.id} className="p-4 bg-gray-50 dark:bg-zinc-800/50 rounded-2xl flex items-center justify-between">
                      <button 
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.95, opacity: 0 }} className="relative w-full max-w-md bg-white dark:bg-zinc-900 rounded-3xl shadow-2xl overflow-hidden p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <button onClick={() => setIsDefaultModalOpen(false)} className="p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full"><X size={20} /></button>
              </div>
